...
export const characterRenderConfig = {
  aria: {
    anchor: { x: 0.86, y: 0.43 }, // Adjust based on Aria's model pivot
    position: { x: 0.4, y: 1.1 }, // Place Aria on the left side
    scale: { x: 0.44, y: 0.54 }, // Adjust scale for Aria
    mouthParam: 'ParamMouthOpenY', // Example parameter name for lip sync
  },
  sera: {
    anchor: { x: 0.5, y: 0.54 }, // Adjust based on Sera's model pivot
    position: { x: 0.5, y: 0.9 }, // Place Sera in the center
    scale: { x: 0.15, y: 0.17 }, // Adjust scale for Sera
    mouthParam: 'ParamMouthForm', // Example parameter name for lip sync
  },
  eidon: {
    anchor: { x: 0.5, y: 0.65 }, // Adjust based on Eidon's model pivot
    position: { x: 0.75, y: 0.78 }, // Place Eidon on the right side
    scale: { x: 0.05, y: 0.07 }, // Adjust scale for Eidon
